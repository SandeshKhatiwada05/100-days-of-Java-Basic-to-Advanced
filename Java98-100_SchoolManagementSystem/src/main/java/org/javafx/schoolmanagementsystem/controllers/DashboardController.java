...
public class DashboardController implements Initializable {
    ...
    private ObservableList<StudentsModel> studentsModels = FXCollections.observableArrayList(
            new StudentsModel(1, "Saisa", "Chepchieng"),
    ...
    private void loadPieChart() {
        pieChart.getData().add(new PieChart.Data("Classes", 213));
        pieChart.getData().add(new PieChart.Data("Attendance", 67));
        pieChart.getData().add(new PieChart.Data("Teachers", 36));
    }
}
